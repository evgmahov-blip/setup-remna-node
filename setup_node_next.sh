...
MODULE_REF="${REMNANODE_REPO_REF:-8bd699823850a1464d6d8cc52894108dc67671ee}"
...
declare -A MODULE_SHA256=(
  ...
  [production/selfsteal-site-manager.sh]="a479d1098278ce717df8f6f39304c45abe67ea6c2822d4e9f1bea435e91eddc8"
